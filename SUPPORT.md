...
Thank you for your interest in the Logboek Dataverwerkingen library (`moza-logboekdataverwerking`). This is a Kotlin library that implements the Dutch government Logboek Dataverwerkingen (LDV) standard for data processing logging, part of the [MijnOverheid Zakelijk (MOZa)](https://github.com/MinBZK/MijnOverheidZakelijk) project.
...
If you've found a bug or want to request a feature, please [open an issue](https://github.com/MinBZK/moza-logboekdataverwerking/issues). Before opening a new issue, we recommend checking whether a similar issue already exists.
